...
(()=>{
    const e = new Error("Cannot find module '../services/authAPI'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../services/userAPI'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
...
const AuthProvider = ({ children })=>{
    ...
    const register = async (email, password, phone, name)=>{
        try {
            const { email: responseEmail } = await authService.register({
                email,
                password,
                phone,
                name
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc49646c._.js.map