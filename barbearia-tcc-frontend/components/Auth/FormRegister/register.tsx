  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
    ...
    return(
      ...
      <div className="style">
        ...
        <button className="submit-button" type="submit" disabled={isSubmitting} style={{ width: "100%", padding: "10px" }}>
          {isSubmitting ? "Criando conta..." : "Cadastrar"}
        </button>
      </form>
      <p className="sem-conta" style={{ marginTop: "1rem", textAlign: "center" }}>
        Já tem uma conta? <Link className="link-cadastrar" href="/login">Faça login</Link>
      </p>
    </div>
    )
    };